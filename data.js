...
const FAQS = [
  ...
  { q: "動画撮影やダンス撮影はできますか？", a: "お客様ご自身による動画撮影は、撮影風景を記録する目的でスマートフォンを使用する場合に限り可能です。TikTokなどのダンス動画、踊ってみた動画、MV・PV、作品として公開する動画など、撮影風景の記録以外を目的とした動画撮影は、ネオンブースを含むすべてのブースで禁止です。" },
  { q: "予約時にXアカウントIDが必要なのはなぜですか？", a: "予約者確認、無断キャンセル・キャンセル料未払い・規約違反等の防止、および予約管理のため、公開されているXアカウントIDの記載を必須としています。鍵アカウントは受付できません。予約代表者がXを利用していない場合は、撮影グループ内のいずれかの方の公開アカウントIDをご記載ください。未払い、虚偽申告、重大な規約違反等があった場合は、状況により同じ撮影グループの方も今後のご利用をお断りすることがあります。" },
...
const FLOW = [
  ...
  { t: "撮影・ご退店", p: "終了時刻の10分前までに撮影を終え、使用したブースと更衣室を原状回復してください。確認後、予約時間内にご退店をお願いします。" },
];
