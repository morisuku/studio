...
const FAQS = [
  ...
  { q: "予約時にXアカウントIDが必要なのはなぜですか？", a: "予約者確認、無断キャンセル・キャンセル料未払い・規約違反等の防止、および予約管理のため、予約代表者ご本人のXアカウントIDを必須としています。表示名ではなく@から始まるIDをご入力ください。鍵アカウントでも問題ありません。Xを利用していない方は、予約前に公式LINEからご相談ください。" },
