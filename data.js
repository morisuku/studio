...
const FAQS = [
  ...
  { q: "動画撮影やダンス撮影はできますか？", a: "お客様ご自身による動画撮影は、その場から移動せず、足元を動かさない状態で行う、手や腕など上半身のみの短時間撮影に限り可能です。足を使ったダンス・踊ってみた・歩行・ジャンプ・ステップ・回転など、立ち位置が変わる動きや全身を使う撮影は、ネオンブースを含むすべてのブースで禁止です。" },
