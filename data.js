...
const BOOTHS = [
  ...
  },
  {
    ...
    photos: ["assets/game1.webp", "assets/game2.webp", "assets/game3.webp", "assets/game4.webp", "assets/game5.webp", "assets/game6.webp"],
...
const FAQS = [
  ...
  { q: "複数ブースを同時間に使用できますか？", a: "2ブース確保プランでは、中華・ピンク・ゲーミング・ネオンから予約時に選んだ1〜2ブースを専用利用できます。背景紙ブースのみ同時間帯の2組で共用です。完全貸切プランでは背景紙を含む全ブースを自由に利用できます。" },
  { q: "何名まで利用できますか？撮影者も人数に含まれますか？", a: "2ブース確保プランは1〜4名、完全貸切プランは1〜8名です。5名以上は完全貸切プランをご利用ください。人数にはコスプレイヤーだけでなく、カメラマン、アシスタント、見学者、付き添いの方もすべて含まれます。" },
  ...
  { q: "未成年だけで利用できますか？", a: "ご利用グループ内には、必ず1名以上の成人（高校生を除く満18歳以上）の同伴が必要です。当日ご来店される全員が未成年（高校生を含む）の場合は、安全管理の都合上ご利用いただけません。なお、ご予約者ご本人が未成年でも、当日成人の同伴者が1名以上いらっしゃれば問題ございません。また、18歳以下の方は初回利用時に親権者同意書の提出が必須です。" },
